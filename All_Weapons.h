...
public:
	...
	//Hull Laser I
	const Weapon laser_hull_i = Weapon("Hull Laser I", "Laser", 14, 2, 10, 50, 1, 1, 1, 0, 2, 0);


	//Missile Weapons - Require Missiles as ammo, ignore shields
		//Test Missile
	const Weapon missile_test = Weapon("TEST_MISSILE", "Missile", 12, 1, 10, 2, 0, 20, 10, 2, 2, 0);
	//Artemis
	Weapon missile_artemis = Weapon("Artemis", "Missile", 11, 1, 10, 2, 0, 0, 0, 1, 1, 0);
	//Hermes
	...
	//Bomb Weapons - Requires Missiles as ammo, ignore shields and hull
		//Test Bomb
	const Weapon bomb_test = Weapon("TEST_BOMB", "Bomb", 15, 1, 10, 10, 0, 30, 10, 2, 2, 0);
	//Small Bomb
	const Weapon bomb_small = Weapon("Small Bomb", "Bomb", 13, 1, 10, 0, 0, 30, 2, 1, 0, 0);
	// Fire Bomb
	const Weapon bomb_fire = Weapon("Fire Bomb", "Bomb", 15, 1, 10, 10, 0, 30, 2, 9, 0, 0);
	// Breach Bomb I
	const Weapon bomb_breach_i = Weapon("Breach Bomb I", "Bomb", 9, 1, 10, 0, 0, 30, 1, 0, 10, 0);
	// Cyrstal Lock Bomb
